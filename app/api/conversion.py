...
async def convert_latex_to_html(
    ...
    options: Optional[str] = Form(None)  # pylint: disable=unused-argument
) -> ConversionResponse:
    """
...
async def get_conversion_status(conversion_id: str) -> JSONResponse:
    """
...
async def download_conversion_result(conversion_id: str) -> None:
    """
